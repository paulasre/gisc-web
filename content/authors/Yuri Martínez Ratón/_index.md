---
# Display name
title: Yuri Martínez Ratón

# Full name (for SEO)
first_name: Yuri
last_name: Martínez Ratón
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:yuri@math.uc3m.es'
  - icon: google-scholar
    icon_pack: ai
    link: https://sites.google.com/view/homepageof-yuri-martinez-raton/inicio
  - icon: orcid
    icon_pack: fab
    link: https://orcid.org/0000-0002-8199-0207
  - icon: globe
    icon_pack: fas
    link: 'https://sites.google.com/view/homepageof-yuri-martinez-raton/inicio'
